...
class Roamer:
    ...
    def smart_lidar_cb(self, msg):
        ...
        the_rules = [
            ["if too_close: stop", "self.too_close()", "self.stop()"],
            ["if too far: stop", "self.too_far()", "self.stop()"],
            ["if a little close, go towards right", "self.little_close()", "self.go_towards_right()"],
            ["if a little far, go towards left", "self.little_far()", "self.go_towards_left()"]
         ]
